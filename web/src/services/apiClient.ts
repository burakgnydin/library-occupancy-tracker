...
// Mobildeki apiClient.ts ile ayni mantik (bkz. mobile/src/services/apiClient.ts) -
// tek fark storage katmani: native tarafta expo-secure-store, burada duz web
// uygulamasi oldugu icin localStorage kullaniliyor (bu proje icin yeterli,
// ekstra bir sifreleme katmanina gerek yok).
...
// bu iki olay disaridan (authStore modulu yuklenirken) kaydedilir - bkz.
// mobile/src/services/apiClient.ts'deki ayni desen.
